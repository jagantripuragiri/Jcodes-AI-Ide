...
const geminiModelOptions = { // https://ai.google.dev/gemini-api/docs/pricing
	...
	'gemini-2.5-pro': {
		contextWindow: 1_048_576,
		reservedOutputTokenSpace: 8_192,
		cost: { input: 1.25, output: 10.00 }, // TODO price doubles for >200K token prompts
		downloadable: false,
		supportsFIM: false,
		supportsSystemMessage: 'separated',
		specialToolFormat: 'gemini-style',
...
const microsoftAzureSettings: VoidStaticProviderInfo = {
	...
	modelOptionsFallback: (modelName) => { return { modelName: 'gpt-5.4', recognizedModelName: 'gpt-5.4', ...microsoftAzureModelOptions['gpt-5.4'] } },
	providerReasoningIOSettings: {
		input: { includeInPayload: openAICompatIncludeInPayloadReasoning },
	},
}
...
const openRouterModelOptions_assumingOpenAICompat = {
	...
	'deepseek/deepseek-r1-0528': {
		...
		reservedOutputTokenSpace: null,
		cost: { input: 0.50, output: 2.15, cache_read: 0.35 },
		downloadable: false,
	},
	'google/gemma-4-31b-it:free': {
