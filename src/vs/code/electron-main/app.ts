...
import { GitHubChannel } from '../../workbench/contrib/void/electron-main/voidGitHubChannel.js';
/**
...
export class CodeApplication extends Disposable {
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		// Void added this - GitHub Account Manager (shells out to the `gh` CLI, see voidGitHubChannel.ts)
		const githubChannel = new GitHubChannel();
		mainProcessElectronServer.registerChannel('void-channel-github', githubChannel);
