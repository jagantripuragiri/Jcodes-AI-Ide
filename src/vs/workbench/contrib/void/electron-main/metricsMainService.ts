...
export class MetricsMainService extends Disposable implements IMetricsService {
	...
	async initialize() {
		...
		const { commit, version, jcodesVersion, release, quality } = this._productService
	...
	capture: IMetricsService['capture'] = (event, params) => {
		// metrics reporting disabled - no external service to send to
	}
