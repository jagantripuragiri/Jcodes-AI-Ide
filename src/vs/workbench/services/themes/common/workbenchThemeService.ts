...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'GitHub Dark', // Void changed this from 'Default Dark Modern'
...
export const COLOR_THEME_DARK_INITIAL_COLORS = { // Void changed this to match GitHub Dark (mono black/white, no blue)
